...
import com.example.e_comm_home_demo_app.util.Constants.BASE_URL
import com.example.e_comm_home_demo_app.util.HttpHandleIntercept
...
object ApiModule {
    ...
    @Provides
    @Singleton
    fun provideOkHttpClient(httpHandleIntercept: HttpHandleIntercept): OkHttpClient{
